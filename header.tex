...
\newcommand{\Csechs}[1]{C_{3,#1}}
\newcommand{\Cdrei}[1]{C_{4,#1}}
\newcommand{\Cvier}[2]{C_{5,#1,#2}}
\newcommand{\Cfive}[2]{C_{6,#1,#2}}
\newcommand{\Cdetvier}[2]{C^{\det}_{5,#1,#2}}
\newcommand{\Cdetfive}[2]{C^{\det}_{6,#1,#2}}
