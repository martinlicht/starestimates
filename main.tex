...
\begin{align}\label{math:esposito:poincare}
    ...
    .
\end{align}
In the limit case $p=1$, the optimal Poincar\'e constant $1/2$ also coincides with the optimal Poincar\'e--Friedrichs constant, as can verified with some one-dimensional example. % TODO Acosta-Duran %\footnote{In the case $p=1$, the optimal Poincar\'e constant $1/2$ is an upper bound for the optimal Poincar\'e--Friedrichs constant. When $\Omega = (0,1)$, then $u(x) = x - 0.5$ is }
