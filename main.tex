...
\begin{table}[t]
    ...
    Computed via lowest-order finite element methods. The upper bound in Lemma~\ref{lemma:mixedbconsimplex:exteriorderivative} is $0.45015815807$.
...
Enumerating all the paths between tetrahedra in our example triangulations is feasible but takes considerably longer. 
Brute-force enumeration of all shellings seems infeasible, though. 
Instead, 

\todo{How to select shellings}
