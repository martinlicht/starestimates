...
For this illustration, we le $\Omega \subseteq \bbR^3$ be a bounded connected open set. 
...
Let us briefly discuss the practical limitations of the aforementioend estimates for Poincar\'e--Friedrichs constants for convex domains or domains that are star-shaped with respect to a ball. 
...
In view of this, we refrain from treating local patches (stars) in triangulations as domains star-staped with respect to a ball. 
...
\subsection{Review: Combinatorial constants over face-connected triangulated domains}
