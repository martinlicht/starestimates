...
and the \textit{aspect shape measure} $\kappa_{\maxcol}(T)$ 
by 
...
\begin{align}\label{math:shapemeasure:triangulation}
    ...
    .
\end{align}
We call these the geometric, algebraic, and aspect shape measure, respectively, of the triangulation. 
...
%         \end{align*}
        ...
        \begin{align*}
            \tan(\beta) = \frac{\|b_z\|}{\|h_z\|} \leq (k+1) \kappa_{\maxcol}(T).
        \end{align*}
        We conclude that 
        \begin{gather*}
            \| \Jacobian\Phi_{K} \| 
