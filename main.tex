...
\begin{proof}
    ...
    \todo{
    We assume that the underlying space $\underlying{\calT}$ is connected. 
    ...
    We can choose a sequence of $n$-simplices $S = \hat S_0,\hat S_1,\dots,\hat S_m=S' \in \calT$ that cover the path and whose intersections with the path are homeomorphic to $[0,1]$.
    }
