...
\begin{proof}
    ...
    \begin{itemize}
    \item 
    We use the following auxiliary lemma. Suppose that $\|\cdot\|_{\alpha}$ and $\|\cdot\|_{\alpha}$ are two norms on a Banach space.
    Let 
    $$
    ...
    \item 
    We let $S^{n}_{\star} := S^{n} \setminus \{e_{n+1}\} \subseteq \bbR^{n+1}$ be the unit sphere without the North pole. 
    Suppose that $\bar x \in S^n$ is a point on the unit sphere and $\bar x \neq e_{n+1}$. 
    ...
    \begin{align}
        ...
        .
    \end{align}
    This is a mapping $\pi : S^{n}_{\star} \rightarrow \bbR^{n}$. 
    ...
    \item 
    \begin{align}
        F^{-1} \pi^{-1} G^{-1} \mu G \pi F
    \end{align}
    \item 
    We use the following result~\cite[Theorem~3]{alestalo2018radial}:
    if $f : S \rightarrow S$ is an $L$-Lipschitz mapping from the Euclidean unit sphere into itself, 
    then the radial extension $f : B \rightarrow B$ is an $L$-Lipschitz mapping from the Euclidean unit ball into itself.
    \end{itemize}
\end{proof}
