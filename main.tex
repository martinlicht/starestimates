...
\begin{proof}\color{magenta}
    ...
    \begin{itemize}
        ...
        Let us write $\rho = \min(1,\varrho)$. 
        We define $y = - \rho \hat z_{S'}$ as vector in the opposite direction of $z_{S'}$ and with length $\rho$. 
        ...
        The singular value $\sigma_{\max}(\Theta,G) \geq 1$ is monotonically increasing in $\tan(\beta)$ and must hence be the maximal singular value of $\Jacobian\Theta_{|G}$.
        Moreover, $\sigma_{\min}(\Theta,G) = \rho / \sigma_{\max}(\Theta,G) \leq \rho \leq 1$ must be the smallest singular value of $\Jacobian\Theta_{|G}$.
...
%             \frac{ \diam(T)^{n} }{ \vol(T) }
        ...
        \begin{align}
            ...
            \sigma_{2}(\Theta,x) = \dots = \sigma_{n-1}(\Theta) = 1,
            \quad 
            \sigma_{n}(\Theta,x)^{-1} \leq \mu_{T,\ell} / \rho.
        \end{align}
