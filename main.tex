...
Still in the Hilbert space case $p=2$, the Friedrichs inequality~\cite{burenkov1998sobolev} over the Sobolev space
with homogeneous Dirichlet boundary conditions on $\partial \Omega$ implies~\eqref{math:intro:Wdiv} via duality. 
However, that easy observation seems restricted to $p=2$. 
