...
the latter being computed as solutions of finite element eigenvalue problems in mixed formulation over sufficiently refined meshes. 
...
Future estimates should tighten the gap towards the actual computed values, including for ill-shaped simplices.
...
However, we believe there are ample opportunities for refining our estimates of Poincar\'e--Friedrichs constants, both conceptually and algorithmically, and extending the technique to further applications.
