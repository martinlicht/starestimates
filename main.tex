...
\begin{align}\label{math:algebraicshapemeasure}
    \alpha(T)
    := 
    \sup_{ \varphi : \Delta^n \rightarrow T } 
    \frac{ \sigma_{\max}( \Jacobian \varphi ) }{ \sigma_{\max}( \Jacobian \varphi ) }
    ,
    \qquad 
    \alpha(\calT) := \sup_{ T \in \subsimplex_{n}(\calT) } \alpha(T)
    ,
\end{align}
where the first suprenum is taken over all affine transformation from the reference $n$-simplex onto the $n$-simplex $T$. 
...
\begin{theorem}\label{theorem:starreflection}
    ...
    satisfying
    \begin{align*}
        \Lip( \Xi,      T ) \leq \Cvier{n}{k} \kappa(\calT)^{2},
        \quad 
        \Lip( \Xi^{-1}, U ) \leq \Cfive{n}{k} \kappa(\calT)^{2},
    \end{align*}
...
\begin{proof}
    ...
    \begin{gather*}
        ...
        \leq 
        2^{\frac n p}
        |\det( \Jacobian \varphi )|^{-\frac 1 p} \| \Jacobian \varphi \| \cdot 
        \| \cartan u \|_{L^{p}(T)}
        .
    \end{gather*}
