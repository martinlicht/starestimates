...
%             \end{pmatrix}
        ...
        \begin{align*}
            ...
            =
%             \frac{1}{2} 
%             \left( \sqrt{ \left( 1 + \frac 1 2 \right)^2 + \frac 9 4 \tan(\beta)^2 } + \sqrt{ \left( 1 - \frac 1 2 \right)^2 + \frac 9 4 \tan(\beta)^2 } \right)
%             \\&
%             =
%             \frac{1}{2} 
%             \left( \sqrt{ \frac 9 4 + \frac 9 4 \tan(\beta)^2 } + \sqrt{ \frac 1 4 + \frac 9 4 \tan(\beta)^2 } \right)
%             \\&
%             =
...
%             =
        ...
        \begin{gather}
            ...
            \leq 
            \frac 3 4 \sqrt{ 1 + (\ell+1)^2 \aspectratio(T)^2 } + \frac 1 4 \sqrt{ 1 + 9(\ell+1)^2 \aspectratio(T)^2 }
            \leq 
            1 + \frac{3}{2} (\ell+1) \aspectratio(T) 
            \label{math:phi_max}
            ,
            \\
            ...
            \leq 
            \frac 3 2 \sqrt{ 1 + (\ell+1)^2 \aspectratio(T)^2 } + \frac 1 2 \sqrt{ 1 + 9(\ell+1)^2 \aspectratio(T)^2 }
            \leq 
            2 + 3 (\ell+1) \aspectratio(T) 
            \label{math:phi_min}
            .
        \end{gather}
...
%         \end{align*}
        ...
        \begin{align*}
            ...
            \nu_{T,\ell}         
            \cdot 
            \left( 1 + \frac{3}{2} (\ell+1) \aspectratio(T) \right)
            ,
            \\
            \sigma_2(x), \dots, \sigma_n(x) 
            &\leq 
            ...
            \nu_{T,\ell}           
            \cdot 
            \left( 2 + 3 (\ell+1) \aspectratio(T) \right)
            ,
            \\
            \sigma_1(x)^{-1}, \dots, \sigma_{n-1}(x)^{-1}
            &\leq 
        ...
        \begin{align*}
            ...
            \left( 
            % Phi max 
            \left( 1 + \frac 3 2 ( \ell+1 )\aspectratio(\calT) \right)
            % Psi max 
            \nu_{T,\ell}
            \right)
            % Det 
            ...
            \left(
            % Phi^{-1} max 
            \left( 2 + 3 ( \ell+1 )\aspectratio(\calT) \right)
            % Psi^{-1} max 
            \nu_{T,\ell}
            \right)
            % Det 
...
\begin{remark}\label{remark:improved_starreflection}
    The estimates in Proposition~\ref{proposition:starreflection} should be considered as \textit{proof-of-concept} but not as optimal in any sense.
    ...
    \begin{gather*} 
        ...
        \\
        \sigma_2,\dots,\sigma_{n-1} \leq 1.
        %         \det(\Jacobian \Xi) &\leq \diameterratio(\calT) \aspectratio(T_2)
    \end{gather*}
...
\begin{theorem}\label{theorem:poincarefriedrichsestimate:curl}
    ...
    Let $0 \leq \ell_{m} < n$ be such that $T_{m}$ shares $n - \ell$ faces with the previous simplices.
    \begin{itemize}
        \item 
...
\begin{table}[h!]
    ...
    \hline
    Domain & Exact PF & Approximate PF & Ratio 
    \\ 
    \hline
    $\Omega$ & $1.0$ & $1.0$ & $1.0$ 
    \\ 
    ...
    \hline
    \end{tabular}
    \caption{Example table with text and formulas.}
    \label{tab:example}
\end{table}
