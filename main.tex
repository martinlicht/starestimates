...
\begin{align}
    ...
    .
\end{align}
% TODO: double check what is known in the literature 
...
\begin{align*}
    G_{\ell}(x,y) 
    &= 
    \int_0^\infty t^{n-\ell} (t+1)^{\ell-1} |\Omega|^{-1} \chi_{\Omega} \left( x+t(x-y) \right)\,dt
    \\
    &= 
    \sum_{k=0}^{\ell-1}\tbinom{\ell-1}{k} 
    \int_0^\infty t^{n-k-1} |\Omega|^{-1} \chi_{\Omega}\left( x+t(x-y) \right)\,dt 
    \\
    &= 
