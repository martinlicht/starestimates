...
%     .
% \end{align*}
Hence the Poincar\'e--Friedrichs inequality implies the Poincar\'e inequality with 
\begin{align*}
...
Stern~\cite{stern2015banach} provides a generalized projection estimate that implies improved estimate for all $L^p$ spaces with $1 \leq p \leq \infty$:
...
\begin{proof}
    ...
    We use a technical argument
    to generalize them to our situation. 
