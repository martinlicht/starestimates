...
\begin{theorem}\label{theorem:starreflection}
    ...
    satisfying
    \begin{align*}
        \Lip( \Xi,      T ) \leq \Cvier{n}{k} \theta(\calT) \alpha(T)^{2},
        \quad 
        \Lip( \Xi^{-1}, U ) \leq \Cfive{n}{k} \theta(\calT) \alpha(T)^{2},
    \end{align*}
    where $...$ and $\Cfive{n}{k} \leq ...$
    \begin{align*}
        \Cvier{n}{k} \leq 64 \left( \sqrt{n} + 1 \right) \Ceins{n} \Czwei{n}
        ,
        \qquad 
        \Cfive{n}{k} \leq 64 \left( \sqrt{n} + 1 \right) \Ceins{n} \Czwei{n}
    \end{align*}
...
\begin{proof}
    ...
    \begin{itemize}
        ...
        %So $J$ is within the boundary of the star $|\patch_{\calT}(S)|$ and is disjoint from $S$.
        ...
        We first define a new triangulation $\calS$ by the barycentric refinement of the complementary $S'$. 
        ...
        \end{align*}
        in the following manner. Let $T \in \calR'$ be an $n$-dimensional simplex and let $x \in T$ be non-zero. There exists a simplex $K \in \calK$ that intersects the ray $\bbR_0^+ \cdot x$.
        We define 
        \begin{align*}
            \Psi(x) 
            = 
            \frac{ \| A_{T}^{-1} x \|_{1} }{ \| A_{K}^{-1} x \|_{1} } x
            .
        \end{align*}
        ...
        \begin{align*}
            \Psi^{-1}(x) 
            = 
            \frac{ \| A_{K}^{-1} x \|_{1} }{ \| A_{T}^{-1} x \|_{1} } x
            .
        \end{align*}
        ...
        \begin{align*}
            \Psi(x) 
            = 
            \frac{ A_{T}^{-t} \vecone \cdot x }{ A_{K}^{-t} \vecone \cdot x } x
            .
        \end{align*}
        ...
        \begin{align*}
            ...
            &= 
            \frac{ 
                ( A_{T}^{-t} \vecone \cdot y ) 
                ( A_{K}^{-t} \vecone \cdot x )
                -
                ( A_{T}^{-t} \vecone \cdot x )
            ...
            x
            + 
            \frac{ A_{T}^{-t} \vecone \cdot x }{ A_{K}^{-t} \vecone \cdot x } y
            \\&= 
            \frac{ 
                ( A_{T}^{-t} \vecone \cdot y ) 
            }{ 
            ...
            x
            +
            \frac{ A_{T}^{-t} \vecone \cdot x }{ A_{K}^{-t} \vecone \cdot  x } 
            \left( 
                y
                -
                \frac{ 
        ...
        \begin{align*}
            ...
            &\leq 
            \sqrt{n}
            \frac{ \sigma_{\max}( A_{T}^{-1} ) }{ \sigma_{\min}( A_{K}^{-1} ) }
            \left( 
            1
            + 
            n
            \frac{ \sigma_{\max}( A_{T}^{-1} ) \sigma_{\max}( A_{K}^{-1} ) }{ \sigma_{\min}( A_{K}^{-2} ) }
            \right) 
            .
        \end{align*}
        ...
        \begin{align*}
            ...
            &\leq 
            \sqrt{n}
            \frac{ \sigma_{\max}( A_{K}^{-1} ) }{ \sigma_{\min}( A_{T}^{-1} ) }
            \left( 
            1
            + 
            n
            \frac{ \sigma_{\max}( A_{K}^{-1} ) \sigma_{\max}( A_{T}^{-1} ) }{ \sigma_{\min}( A_{T}^{-2} ) }
            \right) 
            .
        \end{align*}
        It follows that 
        ...
        It is continuous and bi-Lipschitz due to Rademacher's theorem. 
