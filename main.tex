...
%             \geq 
        ...
        Any $x \in K \cup K^{c}$ has a unique representation
        \begin{align*}
            x = t z_{S} + x^{\perp}, \quad t \in [-1,1], \quad x^{\perp} \in K \cap K^{c},
        \end{align*}
        where we have 
        \begin{align*}
            t = t(x) := \frac{\langle h_{z},x\rangle}{\langle h_{z},z_{S'}\rangle} 
            .
        \end{align*}
        ...
        \begin{align*}
            \Phi_{K}(x) 
			:= 
			x^{\perp} - \frac 1 2 \left( t(x) - 1 \right) z_{S'}
            = 
			x^{\perp} - \frac 1 2 \left( \frac{\langle h_{z},x\rangle}{\langle h_{z},z_{S'}\rangle} - 1 \right) z_{S'}
            .
        \end{align*}
        We can write 
        \begin{align*}
			...
			x^{\perp} - \frac 1 2 \left( t(x) - 1 \right) z_{S'}
            = 
			x^{\perp} + t(x) z_{S'} - t(x) z_{S'} - \frac 1 2 \left( t(x) - 1 \right) z_{S'}
            = 
			x - t(x) z_{S'} - \frac 1 2 \left( t(x) - 1 \right) z_{S'}
            = 
			x - t(x) z_{S'} - \frac 1 2 \left( 3 t(x) - 1 \right) z_{S'}
            .
        \end{align*}
