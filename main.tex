...
%         Let $\beta$ be the angle between $z_{S'}$ and $h_{z}$. 
        ...
        \begin{align*}
            ...
            .
        \end{align*}
        This establishes bounds on the singular values of the transformation in terms of the mesh geometry. 
        We write 
        \begin{align*}
            \beta_T 
            := 
...
%         \end{align*}
        ...
        \item 
        Consider any $n$-simplex $R \in \calR$ and let $R^c \in \calR^{c}$ be its image under $\Theta$.
        We construct a bi-Lipschitz mapping 
        \begin{align*}
            \Gamma_{R} : R \cup R^{c} \rightarrow R^{c}
        \end{align*}
        and analyze its properties. The construction will be such that the union of $\Gamma_{R}$ for all $n$-simplices $R \in \calR$
        will define a bi-Lipschitz mapping 
        \begin{align*}
            \Gamma : \underlying{\calR'} \rightarrow \underlying{\calR^{c}}
        \end{align*}
        ...
        Given $x \in K \cup K^{c}$, we can write uniquely
        \begin{align*}
        ...
        We define 
        \begin{align*}
            \Gamma_{K}(x) = x - \frac 1 2 \left( \frac{\langle h_{z},x\rangle}{\langle h_{z},z_{S'}\rangle} - 1 \right) z_{S'}
        \end{align*}
        We readily verify that this transformation satisfies the desired properties. 
        It remains to analyze its Jacobian.
        ...
        \begin{align*}
            \sigma_{\max} = \sqrt{ \frac{ \tan(\beta)^{2} + 5 }{8} + \frac 1 8 \sqrt{ \tan(\beta)^{4} + 10 \tan(\beta)^{2} + 9 } }
            ,
            \\
            \sigma_{\min} = \sqrt{ \frac{ \tan(\beta)^{2} + 5 }{8} - \frac 1 8 \sqrt{ \tan(\beta)^{4} + 10 \tan(\beta)^{2} + 9 } }
            .
        \end{align*}
        These are also the maximal and minimal eigenvalues of the Jacobian $\Jacobian \Gamma$,
        the remaining eigenvalues being equal to $1$. Upon close inspection, we see that 
        \begin{align*}
