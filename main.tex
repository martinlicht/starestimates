...
We compare computed Poincar\'e--Friedrichs constants over the reference tetrahedron with tangential boundary conditions along a few faces. 
...
\begin{table}[t]
    ...
    Computed via lowest-order finite element methods. The upper bound in Lemma~\ref{} is $0.45015815807$.
