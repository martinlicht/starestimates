...
In practice, we not always distinguish between points and singleton simplices. % TODO: see whether being formally correct iis possible 
...
\begin{lemma}    
    ...
    In particular, $T_{0} \cup T_{1} \cup \dots \cup T_{m}$ is a manifold with boundary for all $m \geq 0$.
\end{lemma}
\begin{proof}    
\end{proof}
