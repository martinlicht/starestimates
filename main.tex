...
Brute-force enumeration of all shellings seems infeasible, though. 
Instead, 

\todo{1. be explicit whether/that a shortest path tree is needed. 2. introduce face shortest-path tree 3. how to enumerate shellings}
