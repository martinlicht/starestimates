...
%     Hence 
    ...
    \begin{align*}
        ...
        .
    \end{align*}
    The desired result now follows from noting $\vol(T_i) = |\det(\Jacobian \varphi_i)|$ and $\| \Jacobian \varphi_i \| \leq \Ceins{n} \diam(T_i)$
    for $i = 1, 2$, where we use Lemma~\ref{lemma:measurerelationships}.
\begin{comment}
