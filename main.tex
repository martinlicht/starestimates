...
\begin{align*}
    ...
    .
\end{align*}
% Here, $A_{\Poinc}(n,\mia)$ is a numerical constant that depends only on $n$ and $\mia$ and which is bounded by $2^{n-\mia}$. 
Here we introduce the numerical constant 
\begin{gather}\label{equation:A_Bogov}
	A_{\Poinc}(n,\mia) := \sum_{\jeza=0}^{n-\mia} \frac{ \tbinom{n-\mia}{\jeza} }{ (n-\jeza)(\jeza+1) },
\end{gather}
...
\begin{align*}
    ...
    \\&
    \leq 
    n A_{\Poinc}(n,\mia) \frac{ \vol_{}(B_{\diam(\Omega)}(0)) }{\vol(\Omega)} 
    \diam(\Omega)
    \| u \|_{L^{p}(\Omega)}
    .
\end{align*}
...
\end{gather*}
% Its operator norm is bounded by $n A_{\Poinc}(n,\mia) \vol(\Omega)^{-1} \vol_{}(B_{\diam(\Omega)}(0)) \diam(\Omega)$. 
% 
...
\begin{align*}
    ...
    .
\end{align*}
% Here, $A_{\Bogov}(n,\mia)$ is a numerical constant that depends only on $n$ and $\mia$ and which is bounded by $2^{\mia-1}$. 
Here we introduce the numerical constant 
\begin{gather}\label{equation:A_Bogov}
	A_{\Bogov}(n,\mia) := \sum_{\jeza=0}^{\mia-1} \frac{ \tbinom{\mia-1}{\jeza} }{ (n-\jeza)(\jeza+1) }, 
\end{gather}
...
\begin{align*}
    ...
    \\&
    \leq 
    n A_{\Bogov}(n,\mia) \frac{ \vol_{}(B_{\diam(\Omega)}(0)) }{\vol(\Omega)} 
    \diam(\Omega)
    \| u \|_{L^{p}(\Omega)}
    .
\end{align*}
...
\end{gather*}
% Its operator norm is bounded by $n A_{\Bogov}(n,\mia) \vol(\Omega)^{-1} \vol_{}(B_{\diam(\Omega)}(0)) \diam(\Omega)$. 
...
\begin{align*}
    ...
    \\
    u(x) &= \cartan \Bogov_{n,a} u(x) - \left( \int_{\Omega} u(a) \,da\right) \delta_a, \qquad k = n.
\end{align*}
...
\begin{align}\label{math:hodgedecomposition:bogov}
    ...
    \\
    u(x) &= \cartan \Bogov_{n} u(x) - \left( \vol(\Omega)^{-1} \int_{\Omega} u(a) \,da\right) \chi_{\Omega}, \qquad k = n.
\end{align}
...
\begin{theorem}\label{theorem:PF_EC}
	...
	\begin{align}
		u(x) &= \Poinc_{1} \cartan u(x) - \vol(\Omega)^{-1} \int_\Omega u(a)
		\label{math:theorem:PF_EC:poincare:zero}
		\\
		u(x) &= \cartan \Poinc_{\mia} u(x) + \Poinc_{\mia+1} \cartan u(x), \qquad 1 \leq \mia \leq n.
		\label{math:theorem:PF_EC:poincare:k}
	\end{align}
	...
	\begin{align}
		u(x) &= \cartan \Bogov_{\mia} u(x) + \Bogov_{\mia+1} \cartan u(x), \qquad 0 \leq \mia \leq n-1,
		\label{math:theorem:PF_EC:bogov:k}
		\\
		u(x) &= \cartan \Bogov_{n} u(x) - \left( \vol(\Omega)^{-1} \int_{\Omega} u(a) \,da\right) \chi_{\Omega}.
		\label{math:theorem:PF_EC:bogov:n}
	\end{align}
...
\begin{proof}
	...
	This shows \eqref{math:theorem:PF_EC:poincare:k}, and \eqref{math:theorem:PF_EC:poincare:zero} follows by an approximation argument.
    ...
    This shows \eqref{math:theorem:PF_EC:bogov:k}, and \eqref{math:theorem:PF_EC:bogov:n} follows by an approximation argument.
...
\begin{proof}
	...
	by the topological Sch\"onfliess theorem. 
...
\begin{proposition}\label{proposition:starreflection}
    ...
    and let 
    \begin{align*}
        U := \overline{ \underlying{\patch_{\calT}(S)} \setminus T },
        \qquad 
        {\Gamma_1} := U \cap T,
        \qquad 
...
\begin{proof}
    ...
    This follows from Theorem~\ref{theorem:PF_EC} using $\vol(B_{\diam(\Omega)}(0)) = \vol_{}(B_1(0)) \diam(\Omega)^{n}$.
...
\begin{lemma}\label{lemma:mixedbconsimplex:exteriorderivative}
    ...
    \begin{align*}
        ...
        \leq 
        2^{\frac n p}
        2^{n+1} n A_{\Bogov}(n,k+1) \frac{ \vol_{}(B_1(0)) }{ (\ell+1)/n! } 
...
\begin{proof}
    ...
    \begin{align*}
        \| \tilde w \|_{L^{p}(\tilde U)}
        &\leq 
        n A_{\Bogov}(n,k+1) \frac{ \vol_{}(B_2(0)) }{ \vol(\tilde U) } 
        2
        \| \tilde g \|_{L^{p}(\tilde U)}
        \\&\leq 
        2^{n+1} n A_{\Bogov}(n,k+1) \frac{ \vol_{}(B_1(0)) }{ (l+1)/n! } 
        \| \tilde g \|_{L^{p}(\tilde U)}
        .
    \end{align*}
